...
public class SalesmanAdapter extends BaseAdapter implements Filterable {
    ...
    public SalesmanAdapter(Context context, ArrayList<Report> mProductArrayList){
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint == null || constraint.length() == 0) {
                    ...
                    for (int i = 0; i < mOriginalValues.size(); i++) {
                        String salesman = mOriginalValues.get(i).getSalesman();
                        if ((salesman.toLowerCase().startsWith(constraint.toString()))) {
